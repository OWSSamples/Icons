...
const IcFluentWeatherSnowflake_48Regular = (props: IconProps) => (
  <IconBase {...props} viewBox="0 0 48 48">
    <path fill="currentColor" d="M24.25 3.5c.69 0 1.25.56 1.25 1.25v8.732l5.116-5.116a1.25 1.25 0 0 1 1.768 1.768L25.5 17.018V23h5.982l6.884-6.884a1.25 1.25 0 0 1 1.768 1.768L35.018 23h8.732a1.25 1.25 0 1 1 0 2.5h-8.732l4.866 4.866a1.25 1.25 0 0 1-1.768 1.768L31.482 25.5H25.5v5.982l6.634 6.634a1.25 1.25 0 0 1-1.768 1.768L25.5 35.018v8.732a1.25 1.25 0 1 1-2.5 0v-8.732l-5.116 5.116a1.25 1.25 0 0 1-1.768-1.768L23 31.482V25.5h-5.982l-6.884 6.884a1.25 1.25 0 0 1-1.768-1.768l5.116-5.116H4.75a1.25 1.25 0 1 1 0-2.5h8.732l-5.366-5.366a1.25 1.25 0 0 1 1.768-1.768L17.018 23H23v-5.982l-7.134-7.134a1.25 1.25 0 0 1 1.768-1.768L23 13.482V4.75c0-.69.56-1.25 1.25-1.25"/>
  </IconBase>
);

export default IcFluentWeatherSnowflake_48Regular;
